...
urlpatterns = patterns('',
    ...
    url(r'^_internal/(?P<shortkey>[A-z0-9]+)/create-cloud-env-for-resource/$', views.create_cloud_env_for_resource),
    ...
    url(r'^check_model_run_status/(?P<shortkey>[A-z0-9]+)/$', views.check_model_run_status),
    url(r'^add_model_output_to_resource/(?P<shortkey>[A-z0-9]+)/(?P<output_dir_name>[_A-z0-9]+)/$',
        views.add_model_output_to_resource),
    url(r'^write_model_output_path/(?P<shortkey>[A-z0-9]+)/(?P<output_dir_name>[_A-z0-9]+)/$',
        views.write_model_output_path),
    url(r'^create_resource_with_model_output/(?P<shortkey>[A-z0-9]+)/$',
        views.create_resource_with_model_output),
)
