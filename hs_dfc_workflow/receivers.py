...
def dfcworkflow_pre_create_resource(sender, **kwargs):
    ...
    workflowprocessors = {'workflowprocessors': {'has_DockerImage': False}, \
                          'workflowprocessors': {'has_CodeRepository': False}}
    irodsworkflowprocessors = {'irodsworkflowprocessors':{'has_CodeRepository': False}}
    metadata.append(workflowprocessors)
    metadata.append(irodsworkflowprocessors)
